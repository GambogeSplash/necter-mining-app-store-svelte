...
export const developerRegistry: Record<string, DeveloperProfile> = {
  ...
  "0xTIWA...g3o2": {
    address: "0xTIWA...g3o2",
    name: "TIWA Labs",
    bio: "Building AskTiwa, a decentralized AI-powered knowledge network. Miners contribute compute to power distributed AI inference for natural language queries with privacy-preserving architecture.",
    website: "https://asktiwa.ai",
    logo: "/logos/tiwa.png",
    founded: "2025",
    location: "Global",
    ...
    socialLinks: {},
    verified: true,
    tags: ["AI", "NLP", "Inference", "Privacy", "Knowledge"],
  },
  "0xATUM...r5s4": {
    address: "0xATUM...r5s4",
    name: "Atum Software",
    bio: "Your gateway to a secure, decentralized, and sustainable future. Building a privacy-first ecosystem with decentralized search, node infrastructure, and upcoming decentralized OS. Committed to green energy and carbon-neutral operations.",
    website: "https://atum.software",
    logo: "/logos/atum.jpg",
    founded: "2024",
    location: "Global",
    ...
    socialLinks: {},
    verified: true,
    tags: ["Privacy", "Search", "DePin", "Green", "DAO", "Data Sovereignty"],
  },
}
